...
variable "instance_type" {
  type        = string
  description = "Instance type used for all rancher instances"
  default     = "t3a.medium"
}

variable "instance_count" {
  description = "Number of Rancher server instances to create"
  default     = 1
}

# variable "nodeinstance_type" {
#   type        = string
#   description = "Instance type used for all downstream instances"
#   default     = "t3a.medium"
# }
